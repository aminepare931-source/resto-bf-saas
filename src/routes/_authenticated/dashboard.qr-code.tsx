              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-4 rounded-xl bg-dark-card border border-white/8">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Copiez l'URL publique générée (ex: https://abc123.ngrok.io) et utilisez-la pour
                    scanner le QR code.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-dark-card border border-white/8">
                  ...
                  <p className="text-muted-foreground mb-2">
                    Dans le dashboard, allez dans <strong>Paramètres</strong> et définissez une{" "}
                    <strong>URL publique personnalisée</strong> pour votre restaurant.
                  </p>
                </div>
              </div>
