...
const templates: Tpl[] = [
  ...
  },
  {
    id: "std-soleil",
    name: "Soleil",
    tagline: "Éditorial chaleureux crème",
    plan: "standard",
    vibe: "linear-gradient(135deg,#d4a853,#b08800)",
  },
  {
    id: "std-savane",
    name: "Savane",
    tagline: "Ocre & rust africain",
    plan: "standard",
    vibe: "linear-gradient(135deg,#b95036,#7a2e1d)",
  },
  {
    id: "std-marche",
    name: "Marché",
    tagline: "Couleurs vives Sankariaré",
    plan: "standard",
    vibe: "linear-gradient(135deg,#0f6b4f,#0a4f3a)",
  },
  {
    id: "std-moderne",
    name: "Moderne",
    tagline: "Épuré contemporain",
    plan: "standard",
    vibe: "linear-gradient(135deg,#2c3e50,#1a1a2e)",
  },
  {
    id: "prem-royal",
    name: "Palais Royal",
