...
const PRESETS = [
  {
    name: "Élégant Noir & Or",
    colors: { primary: "#1a1a1a", secondary: "#d4a853", text: "#1a1a1a", background: "#ffffff" },
  },
  {
    name: "Bleu Professionnel",
    colors: { primary: "#1e3a8a", secondary: "#3b82f6", text: "#1e3a8a", background: "#ffffff" },
  },
  {
    name: "Vert Nature",
    colors: { primary: "#166534", secondary: "#22c55e", text: "#166534", background: "#ffffff" },
  },
  {
    name: "Rouge Dynamique",
    colors: { primary: "#991b1b", secondary: "#ef4444", text: "#991b1b", background: "#ffffff" },
  },
  {
    name: "Violet Premium",
    colors: { primary: "#581c87", secondary: "#a855f7", text: "#581c87", background: "#ffffff" },
  },
  {
    name: "Orange Énergique",
    colors: { primary: "#9a3412", secondary: "#f97316", text: "#9a3412", background: "#ffffff" },
  },
];
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl border border-white/10 bg-[#0a0a0f]"
      >
        <div className="p-6 border-b border-white/5 flex justify-between items-center">
          <div>
            <h3 className="text-xl font-black">Personnalisation des factures</h3>
            <p className="text-sm text-muted-foreground mt-1">
              Choisissez les couleurs de vos factures et reçus
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <label className="text-xs text-muted-foreground">
                  Couleur principale (en-têtes, bordures)
                </label>
          ...
          <div className="flex gap-2 justify-end pt-4 border-t border-white/5">
            <button
              onClick={onClose}
              className="px-5 py-2.5 rounded-xl border border-white/10 text-sm font-semibold hover:border-gold/40 transition-colors"
            >
              Annuler
            </button>
            <button
              onClick={saveColors}
              disabled={saving}
              className="px-5 py-2.5 rounded-xl bg-gradient-gold text-[#0a0a0f] font-bold text-sm hover:shadow-gold transition-all disabled:opacity-60"
            >
