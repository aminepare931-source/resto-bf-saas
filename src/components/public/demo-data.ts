...
const menu: PublicMenuItem[] = [
  {
    id: "m1",
    category: "Entrées",
    name: "Salade kapokier",
    description: "Feuilles de kapokier, oignons frais, tomates locales, vinaigrette au sésame.",
    price: 2500,
    image_url: null,
    available: true,
  },
  {
    ...
    description: "Capitaine du Niger mariné au gingembre, grillé au feu de bois.",
    price: 3500,
    image_url: null,
    available: true,
  },
  {
    ...
    description: "Petits beignets dorés au mil, sauce piment maison.",
    price: 1500,
    image_url: null,
    available: true,
  },
  {
    ...
    name: "Tô sauce gombo",
    description:
      "Le plat emblématique burkinabè : tô de maïs blanc, sauce gombo et viande de bœuf mijotée.",
    price: 4500,
    image_url: null,
    available: true,
  },
  {
    id: "m5",
    category: "Plats",
    name: "Poulet bicyclette flambé",
    description:
      "Poulet fermier mariné 24h, flambé au feu de bois, accompagné de riz gras parfumé.",
    price: 6500,
    image_url: null,
    available: true,
  },
  {
    ...
    description: "Riz parfumé cuit dans son bouillon de mouton, légumes du marché.",
    price: 5500,
    image_url: null,
    available: true,
  },
  {
    id: "m7",
    category: "Plats",
    name: "Brochettes mixtes royales",
    description: "Bœuf, mouton, poulet — assortiment grillé servi avec frites de patate douce.",
    price: 7000,
    image_url: null,
    available: true,
  },
  {
    ...
    description: "Mangue, papaye, ananas du Burkina, jus de bissap.",
    price: 2000,
    image_url: null,
    available: true,
  },
  {
    id: "m9",
    category: "Desserts",
    name: "Beignets de banane miel",
    description: "Beignets tièdes, miel de brousse, glace vanille.",
    price: 2500,
    image_url: null,
    available: true,
  },
  {
    ...
    category: "Boissons",
    name: "Bissap maison",
    description: "Infusion de fleur d'hibiscus, gingembre, citron vert.",
    price: 1000,
    image_url: null,
    available: true,
  },
  {
    ...
    description: "Frais, épicé, fait maison.",
    price: 1000,
    image_url: null,
    available: true,
  },
  {
    ...
    category: "Boissons",
    name: "Dolo artisanal",
    description: "Bière de mil traditionnelle, à découvrir.",
    price: 1500,
    image_url: null,
    available: true,
  },
