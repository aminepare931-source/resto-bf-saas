  ...
  return (
    <div className={`mb-10 ${isCenter ? "text-center" : ""}`}>
      ...
      <h2
        ...
        style={{
          fontFamily: serif ? "'Cormorant Garamond', serif" : "inherit",
          color: theme.text,
...
export function TplNuit(props: TemplateProps) {
  ...
  return (
    <div
      ...
      style={{ background: theme.bg, color: theme.text, fontFamily: "'Inter', sans-serif" }}
    >
      <FontImport />
      ...
      <header className="absolute top-0 inset-x-0 z-30">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-6 flex items-center justify-between gap-4">
          ...
          <nav
            className="hidden md:flex gap-8 text-[11px] uppercase"
            style={{ letterSpacing: "0.3em", color: theme.textMuted }}
          >
            <a href={buildViewHref("about")} className="hover:text-[#c9a35a] transition-colors">
              Histoire
            </a>
            <a href={buildViewHref("menu")} className="hover:text-[#c9a35a] transition-colors">
              Carte
            </a>
            <a href={buildViewHref("home")} className="hover:text-[#c9a35a] transition-colors">
              Galerie
            </a>
            <a href={buildViewHref("reserve")} className="hover:text-[#c9a35a] transition-colors">
              Réserver
            </a>
          </nav>
          <button
        ...
        <section className="relative min-h-screen flex items-end overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto w-full px-5 sm:px-8 pb-20 pt-40">
            <p
              ...
              style={{ color: theme.accent, letterSpacing: "0.55em" }}
            >
            ...
            <div className="mt-8 grid lg:grid-cols-12 gap-8 items-end">
              <p
                className="lg:col-span-7 max-w-xl text-lg leading-relaxed"
                style={{ color: theme.textMuted }}
              >
                {restaurant.description ??
                  `Une expérience culinaire d'exception au cœur de ${restaurant.city}. Produits du terroir, savoir-faire artisanal, ambiance feutrée.`}
              </p>
        ...
        <MetaStrip
          ...
          items={[
            ...
            },
            {
              label: "Réservation",
              value: (
                <a href={`tel:${restaurant.phone}`} className="hover:text-[#c9a35a]">
                  {restaurant.phone}
                </a>
              ),
            },
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-8 sm:gap-12 items-start">
            <div className="lg:col-span-7">
              <p
                ...
                style={{ color: theme.accent, letterSpacing: "0.45em" }}
              >
                — Notre maison —
              </p>
              <h2
              ...
              >
                Une cuisine <span style={{ color: theme.accent }}>d'auteur</span>,<br />
              ...
              >
                {restaurant.description ??
                  `Au cœur de ${restaurant.city}, ${restaurant.name} vous invite à une expérience culinaire mémorable. Produits choisis avec soin, savoir-faire à chaque assiette.`}
              </p>
            </div>
            <aside
              className="lg:col-span-5 lg:pl-10 lg:border-l space-y-8"
              ...
              {rating !== null && (
                <Stat
                  ...
                  value={
                    <span>
                      {rating.toFixed(1)}
                      <span style={{ color: theme.textMuted, fontSize: "0.6em" }}>
              ...
              {signatures.map((d) => (
                <article key={d.id} className="group">
                  ...
                  <div className="mt-5 flex items-baseline justify-between gap-4">
                    ...
                    <span className="font-medium whitespace-nowrap" style={{ color: theme.accent }}>
                      {fmtPrice(d.price)}
                    </span>
                  </div>
                  {d.description && (
      ...
      >
        <div className="max-w-5xl mx-auto">
          <SectionHead
            kicker="— Expérience gastronomique —"
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-10">
            ...
            >
              ...
              <p className="text-sm mb-4" style={{ color: theme.textMuted }}>
                Une expérience culinaire complète avec accord mets-vins
              </p>
            ...
            >
              ...
              <p className="text-sm mb-4" style={{ color: theme.textMuted }}>
                Nos meilleures créations en format découverte
              </p>
              <p className="text-3xl font-black" style={{ color: theme.accent }}>
                25 000 F
              </p>
