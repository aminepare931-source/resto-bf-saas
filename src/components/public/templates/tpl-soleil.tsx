...
export function TplSoleil(props: TemplateProps) {
  ...
  const cats = Array.from(new Set(menu.filter((m) => m.available).map((m) => m.category))).slice(
    0,
    6,
  );
  ...
  const popular = (
    activeTab
      ? menu.filter((m) => m.available && m.category === activeTab)
  ...
  return (
    ...
    >
      ...
      <div style={{ background: theme.surfaceAlt, color: theme.text }} className="text-xs">
        <div className="max-w-6xl mx-auto px-4 sm:px-5 py-2 flex flex-wrap items-center justify-between gap-2">
          <div className="flex flex-wrap gap-x-5 gap-y-1">
            <span>
              <strong>Tél :</strong> {restaurant.phone}
            </span>
          ...
          <span style={{ color: theme.accent, fontWeight: 700 }}>
            ★ Offre : livraison offerte dès 15 000 F
          </span>
        </div>
      </div>
      ...
      <header
        ...
        style={{ background: "rgba(251,243,230,0.95)", borderBottom: `1px solid ${theme.border}` }}
      >
        <div className="max-w-6xl mx-auto px-5 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div>
              <strong
                className="block text-xl sm:text-2xl truncate"
                style={{ fontFamily: "'Baloo 2', sans-serif", fontWeight: 700, color: theme.text }}
              >
                {restaurant.name}
              </strong>
            </div>
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            ...
            {restaurant.plan !== "gratuit" && (
              <a
                ...
                className="hidden md:inline-flex px-5 py-2.5 rounded-full font-bold text-sm hover:scale-105 transition-transform border-2"
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="hidden md:flex w-10 h-10 rounded-full grid place-items-center hover:scale-105 transition"
          ...
          <nav className="md:hidden border-t border-black/10 bg-white/95 backdrop-blur-xl">
            <div className="flex flex-col px-4 py-4 gap-1">
              <a
                ...
                className="px-4 py-3 rounded-xl text-sm font-medium hover:bg-black/5 transition-colors text-left"
              >
                Accueil
              </a>
              <a
              ...
              <a
                ...
                target={wa ? "_blank" : undefined}
                rel="noopener noreferrer"
                className="px-4 py-3 rounded-xl text-sm font-medium hover:bg-black/5 transition-colors flex items-center gap-2"
              >
                <Icon name="cart" size={16} /> Commander
              </a>
            </div>
          </nav>
        )}
          ...
          <section id="home" className="relative">
            <div className="relative w-full h-[86vh] min-h-[560px] max-h-[820px] overflow-hidden">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(20,12,4,0.15) 0%, rgba(20,12,4,0.35) 55%, rgba(20,12,4,0.85) 100%)",
                }}
              />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-end text-center px-5 pb-16 sm:pb-20">
                ...
                <p className="mt-5 max-w-lg leading-relaxed text-white/90 text-sm sm:text-base">
                  {restaurant.description ??
                    `Une cuisine d'excellence préparée avec passion à ${restaurant.city}, ingrédients frais et locaux.`}
                </p>
                <div className="mt-8 flex gap-3 flex-wrap justify-center">
                  <a
                    ...
                    target={wa ? "_blank" : undefined}
                    rel="noopener noreferrer"
                    className="px-8 py-4 rounded-full font-bold text-sm hover:opacity-90 hover:-translate-y-0.5 transition shadow-xl"
                    style={{
                      background: theme.accent,
                      color: theme.accentInk,
                      fontFamily: "'Baloo 2', sans-serif",
                  ...
                  {restaurant.plan !== "gratuit" && (
                    <a
                      href={buildViewHref("reserve")}
                      className="px-8 py-4 rounded-full font-bold text-sm border-2 border-white/70 hover:bg-white hover:text-[#1e1308] transition backdrop-blur-sm"
                      style={{ color: "#ffffff", fontFamily: "'Baloo 2', sans-serif" }}
                    >
                      Réserver une table
                    </a>
                  )}
            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-10">
                <button
                  ...
                  style={{
                    color: activeTab === null ? theme.accent : theme.textMuted,
                    borderBottom:
                      activeTab === null ? `2px solid ${theme.accent}` : "2px solid transparent",
                  }}
                >
                  Tous
                </button>
                {cats.map((c) => (
                  <button
                    ...
                    className="px-4 py-1 text-sm font-medium"
                    style={{
                      color: activeTab === c ? theme.accent : theme.textMuted,
                      borderBottom:
                        activeTab === c ? `2px solid ${theme.accent}` : "2px solid transparent",
                    }}
                  >
                    {c}
                  </button>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 text-left">
                  {popular.map((d, i) => (
                    <button
                      ...
                      className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition group text-left w-full"
                    >
                      <div
                      ...
                      >
                        ...
                        <span
                          className="absolute top-2 left-2 px-2 py-0.5 rounded-md bg-white/95 text-[10px] font-bold"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-lg leading-relaxed mb-6" style={{ color: theme.text }}>
                {restaurant.description ??
                  `Bienvenue au ${restaurant.name}, votre restaurant préféré à ${restaurant.city}. Nous vous proposons une cuisine ${restaurant.cuisine ?? "traditionnelle"} préparée avec des ingrédients frais et locaux.`}
              </p>
              {restaurant.address && (
                <div
                ...
                >
                  ...
                  >
                    <Icon name="pin" size={14} /> Adresse
                  </p>
                  <p style={{ color: theme.text }}>{restaurant.address}</p>
                  {restaurant.hours && (
                    <>
                      <p
                        className="text-sm font-bold uppercase tracking-wider mt-4 mb-2 flex items-center gap-1.5"
                        style={{ color: theme.accent }}
                      >
                        <Icon name="clock" size={14} /> Horaires
                      </p>
                      <p style={{ color: theme.text }} className="whitespace-pre-line">
                        {restaurant.hours}
                      </p>
                    </>
                  )}
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              ...
              >
                ...
                <p className="text-sm mb-4" style={{ color: theme.textMuted }}>
                  Menu spécial et décoration personnalisée
                </p>
                <p className="text-lg font-black" style={{ color: theme.accent }}>
                  À partir de 15 000 F/pers
                </p>
              </div>
              <div
                className="p-6 rounded-2xl text-center"
              ...
              >
                ...
                <p className="text-sm mb-4" style={{ color: theme.textMuted }}>
                  Ambiance intimiste et menu duo
                </p>
                <p className="text-lg font-black" style={{ color: theme.accent }}>
                  À partir de 20 000 F
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="px-5 py-7" style={{ background: "#8b3a1c" }}>
          <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-center gap-6">
            <strong
              ...
              style={{ fontFamily: "'Baloo 2', sans-serif" }}
            >
              Savourez le meilleur, commandez maintenant
            </strong>
            <a
              href={wa ?? buildViewHref("menu")}
              target={wa ? "_blank" : undefined}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-10">
              ...
              >
                ...
                <p className="text-sm mb-4" style={{ color: theme.textMuted }}>
                  Dînez en cuisine et observez le chef à l'œuvre
                </p>
                <p className="text-lg font-black" style={{ color: theme.accent }}>
              ...
              >
                ...
                <p className="text-sm mb-4" style={{ color: theme.textMuted }}>
                  Menu personnalisé avec accord mets-vins
                </p>
                <p className="text-lg font-black" style={{ color: theme.accent }}>
                  À partir de 40 000 F/pers
                </p>
              </div>
            </div>
          </div>
