  ...
  return (
    <div className={`mb-10 ${isCenter ? "text-center" : ""}`}>
      ...
      <h2
        ...
        style={{
          fontFamily: serif ? "'Playfair Display', serif" : "inherit",
          color: theme.text,
    ...
    >
      ...
      <header className="absolute top-0 inset-x-0 z-30">
        <div
          ...
          style={{
            background: "linear-gradient(180deg, rgba(14,14,16,0.65) 0%, rgba(14,14,16,0) 100%)",
          }}
        />
        <div className="relative max-w-7xl mx-auto px-5 py-5 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-6">
            <nav
              className="hidden md:flex gap-6 text-[12px] uppercase font-medium"
              style={{
        ...
        >
          ...
          <div className="relative text-center px-5 pt-32 pb-20 max-w-3xl">
            ...
            >
              ...
              <br />
              pour <em style={{ color: theme.accent, fontStyle: "italic" }}>votre goût</em>
            </h1>
            <p className="mt-5 max-w-xl mx-auto" style={{ color: theme.textMuted }}>
              {restaurant.description ??
                `Une expérience culinaire d'exception au cœur de ${restaurant.city}.`}
            </p>
            <a
              href={buildViewHref("menu")}
          ...
          <div className="relative max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(circle, ${theme.accent} 1px, transparent 1px)`,
            ...
            <div>
              ...
              <p className="leading-relaxed mb-8" style={{ color: theme.textMuted }}>
                {restaurant.description ??
                  "Depuis nos débuts, nous mettons l'accent sur la qualité, l'authenticité et l'art du dressage. Chaque plat est une promesse de découverte."}
              </p>
              ...
              <ul className="space-y-2 mb-8">
                {[
                  "Ingrédients sélectionnés avec soin",
                  "Service attentionné et personnalisé",
                  "Carte renouvelée selon les saisons",
                ].map((s) => (
                  <li
                    key={s}
