  ...
  return (
    <div className={`mb-10 ${isCenter ? "text-center" : ""}`}>
      ...
      <h2
        ...
        style={{
          fontFamily: serif ? "'Archivo Black', sans-serif" : "inherit",
          color: theme.text,
    ...
    >
      ...
      <section className="relative overflow-hidden" style={{ background: heroOverlay }}>
        ...
        <header className="relative">
          <div className="max-w-7xl mx-auto px-5 py-5 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-5">
              <nav
                className="hidden md:flex gap-5 text-[12px] uppercase font-bold text-white/90"
                style={{ letterSpacing: "0.18em" }}
              >
                <a
                  href={buildViewHref("home")}
                  className={`hover:text-white ${activeView === "home" ? "text-white" : ""}`}
                >
                  Accueil
                </a>
                <a
                  href={buildViewHref("menu")}
                  className={`hover:text-white ${activeView === "menu" ? "text-white" : ""}`}
                >
                  Menu
                </a>
              </nav>
              {restaurant.plan !== "gratuit" && (
                <a
                  ...
                  className="hidden md:inline-flex px-5 py-2.5 rounded-full font-bold text-sm hover:scale-105 transition border-2 border-white"
                  style={{ color: "#ffffff" }}
                >
                  Réserver
                </a>
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="hidden md:inline-flex px-5 py-2.5 rounded-full font-bold text-sm hover:scale-105 transition"
          ...
          <nav className="md:hidden border-t border-white/10 bg-[#0e0e10]/95 backdrop-blur-xl">
            <div className="flex flex-col px-4 py-4 gap-1">
              <a
                ...
                className="px-4 py-3 rounded-xl text-sm font-medium text-white hover:bg-white/10 transition-colors text-left"
              >
                Accueil
              </a>
              <a
        ...
        {activeView === "home" && (
          <div className="relative max-w-7xl mx-auto px-5 pt-8 pb-28 grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <p
                className="text-sm font-bold uppercase mb-3 tracking-widest"
                style={{ color: theme.accent, textShadow: "0 2px 8px rgba(0,0,0,0.3)" }}
              >
                ★ Le goût qui claque
              </p>
              <h1
              ...
              <p
                className="mt-6 text-white max-w-md text-lg leading-relaxed"
                style={{ textShadow: "0 2px 10px rgba(0,0,0,0.3)" }}
              >
                {restaurant.description ??
                  `Les meilleurs burgers, brochettes et fast-food de ${restaurant.city}, livrés chauds.`}
              </p>
              <div className="mt-7 flex gap-3 flex-wrap">
                <a
                  href={buildViewHref("menu")}
                  className="inline-block px-8 py-4 rounded-full font-black text-sm hover:scale-105 transition shadow-xl"
                  style={{ background: theme.accent, color: theme.accentInk }}
                >
                  VOIR LE MENU →
                </a>
                <a
                  ...
                  target={wa ? "_blank" : undefined}
                  rel="noopener noreferrer"
                  className="inline-block px-8 py-4 rounded-full font-black text-sm border-2 border-white hover:bg-white hover:text-red-600 transition shadow-lg"
                >
                  COMMANDER
                </a>
              </div>
            ...
            <div className="relative">
              {cover ? (
                <StorageImage
                  path={cover}
                  alt={restaurant.name}
                  className="w-full aspect-square object-cover rounded-full shadow-2xl border-8 border-white/20"
                />
              ) : (
                <div
        ...
        {activeView === "about" && (
          <div className="max-w-6xl mx-auto px-5 py-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                {restaurant.description ??
                  `Bienvenue au ${restaurant.name}, votre fast-food préféré à ${restaurant.city}. Nous vous proposons les meilleurs burgers, brochettes et plats rapides, préparés avec des ingrédients frais.`}
              </p>
              {restaurant.address && (
                <div className="mt-6 p-6 rounded-2xl bg-white/10 backdrop-blur border border-white/20">
                  ...
                  {restaurant.hours && (
                    <>
                      ...
                      <p style={{ color: "#ffffff" }} className="whitespace-pre-line">
                        {restaurant.hours}
                      </p>
                    </>
                  )}
          ...
          <div className="relative max-w-5xl mx-auto px-5 -mb-14 translate-y-14">
            <div className="bg-white rounded-full shadow-2xl px-6 py-4 grid grid-cols-2 sm:grid-cols-[1fr_1fr_auto] gap-4 items-center">
              ...
              <a
                ...
                target={wa ? "_blank" : undefined}
                rel="noopener noreferrer"
                className="hidden sm:inline-block px-6 py-2.5 rounded-full font-bold text-sm whitespace-nowrap"
                style={{ background: theme.accent, color: theme.accentInk }}
              >
                COMMANDER
              </a>
      ...
      {activeView === "home" && (
        <section className="px-5 pt-28 pb-12">
          <div
            className="max-w-6xl mx-auto rounded-[28px] overflow-hidden grid lg:grid-cols-[1fr_auto] gap-6 p-8 sm:p-10 items-center"
          ...
          >
            <div className="text-white">
              ...
              <p className="mt-3 text-white/85 max-w-md">
                Choisis, paie, et déguste — c'est aussi simple que ça.
              </p>
              <a
                href={wa ?? buildViewHref("menu")}
                target={wa ? "_blank" : undefined}
                rel="noopener noreferrer"
                className="mt-5 inline-block px-7 py-3 rounded-full font-bold text-sm"
                style={{ background: theme.accent, color: theme.accentInk }}
              >
            ...
            <div className="grid sm:grid-cols-3 gap-5">
              {signatures.map((d, i) => (
                <div
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") setOpenDish(d);
                  }}
                  className="rounded-3xl overflow-hidden text-left shadow-md hover:shadow-2xl hover:-translate-y-1 transition cursor-pointer"
                  style={{
                    background: i % 2 === 0 ? RED : theme.accent,
                    color: i % 2 === 0 ? "#fff" : theme.accentInk,
                  }}
                >
                  ...
                  <div className="p-5">
                    ...
                    {d.description && (
                      <p className="text-sm mt-1 opacity-85 line-clamp-2">{d.description}</p>
                    )}
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <a
                        ...
                        className="px-4 py-1.5 rounded-full font-bold text-xs bg-white"
                        style={{ color: RED }}
                      >
                        COMMANDER
                      </a>
      ...
      <PoweredFooter
        ...
        theme={{
          ...
          surfaceAlt: "#1a0d05",
          text: "#fff8e7",
          textMuted: "rgba(255,248,231,0.65)",
          accent: theme.accent,
