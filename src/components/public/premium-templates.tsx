          ...
          <>
            ...
            <section className="premium-strip" aria-label="Fonctionnalités premium">
              {[
                ...
                ["🛒", "Commandes", "Envoi direct en cuisine, suivi en temps réel"],
...
.premium-brand{display:grid;text-decoration:none;color:var(--pr-text);min-width:0}.premium-brand span{font-family:var(--pr-serif);font-size:clamp(22px,3vw,34px);line-height:1;font-weight:700}.premium-brand small{color:var(--pr-accent);font-size:10px;text-transform:uppercase;letter-spacing:.24em;margin-top:4px}.premium-nav nav{display:flex;gap:22px}.premium-nav nav a{color:var(--pr-muted);font-size:12px;text-decoration:none;text-transform:uppercase;letter-spacing:.18em;position:relative;padding-bottom:3px;transition:color .25s}.premium-nav nav a::after{content:"";position:absolute;left:0;right:100%;bottom:0;height:1px;background:var(--pr-accent);transition:right .3s cubic-bezier(.16,1,.3,1)}.premium-nav nav a:hover{color:var(--pr-accent)}.premium-nav nav a:hover::after{right:0}.premium-book{background:var(--pr-accent);color:var(--pr-ink);padding:10px 18px;border-radius:999px;font-weight:800;text-decoration:none;font-size:12px;text-transform:uppercase;letter-spacing:.12em;border:1px solid var(--pr-accent);transition:transform .18s,box-shadow .25s;box-shadow:0 0 0 0 color-mix(in oklab,var(--pr-accent) 60%,transparent);}.premium-book:hover{box-shadow:0 6px 24px color-mix(in oklab,var(--pr-accent) 55%,transparent);transform:translateY(-2px)}.premium-book:active{transform:scale(.93) translateY(0);box-shadow:0 2px 10px color-mix(in oklab,var(--pr-accent) 45%,transparent)}.premium-hamburger{display:none;flex-direction:column;gap:5px;background:none;border:none;cursor:pointer;padding:6px;z-index:30}.premium-hamburger-line{width:22px;height:2px;background:var(--pr-text);transition:all .3s;border-radius:2px}.premium-hamburger-line.open:nth-child(1){transform:rotate(45deg) translate(5px,5px)}.premium-hamburger-line.open:nth-child(2){opacity:0}.premium-hamburger-line.open:nth-child(3){transform:rotate(-45deg) translate(5px,-5px)}.premium-mob-menu{display:none;position:sticky;top:60px;background:color-mix(in oklab,var(--pr-bg) 92%,transparent);backdrop-filter:blur(18px);border-bottom:1px solid var(--pr-border);padding:16px;z-index:25;flex-direction:column;gap:8px}.premium-mob-menu a{color:var(--pr-text);text-decoration:none;font-size:14px;font-weight:700;padding:10px 14px;border-radius:8px;transition:background .2s}.premium-mob-menu a:hover{background:rgba(255,255,255,.08)}
.premium-hero{min-height:calc(100vh - 74px);display:grid;grid-template-columns:minmax(0,1fr) minmax(250px,360px);align-items:end;gap:40px;padding:clamp(90px,12vw,160px) clamp(18px,5vw,72px) 54px;}.premium-hero-copy{max-width:860px}.premium-kicker{color:var(--pr-accent);font-size:11px;text-transform:uppercase;letter-spacing:.36em;font-weight:900;margin-bottom:18px}.premium-hero h1{font-family:var(--pr-serif);font-size:clamp(54px,11vw,142px);line-height:.86;margin:0;text-wrap:balance;text-shadow:0 18px 60px rgba(0,0,0,.65)}.premium-lead{max-width:680px;color:var(--pr-muted);font-size:clamp(16px,2vw,22px);line-height:1.7;margin:28px 0 0}.premium-actions{display:flex;flex-wrap:wrap;gap:12px;margin-top:32px}.premium-actions a{border:1px solid var(--pr-border);color:var(--pr-text);background:rgba(255,255,255,.04);padding:13px 20px;border-radius:999px;text-decoration:none;font-size:13px;font-weight:800;transition:transform .18s,box-shadow .25s,border-color .25s}.premium-actions a:hover{border-color:var(--pr-accent);box-shadow:0 6px 20px color-mix(in oklab,var(--pr-accent) 25%,transparent);transform:translateY(-2px)}.premium-actions a:active{transform:scale(.94)}.premium-actions a:first-child{background:var(--pr-accent);color:var(--pr-ink);border-color:var(--pr-accent);box-shadow:0 0 0 0 color-mix(in oklab,var(--pr-accent) 60%,transparent)}.premium-actions a:first-child:hover{box-shadow:0 8px 28px color-mix(in oklab,var(--pr-accent) 55%,transparent)}.premium-hero-panel{display:grid;gap:10px}.premium-hero-panel div{background:var(--pr-surface);border:1px solid var(--pr-border);padding:20px;backdrop-filter:blur(14px);border-radius:var(--pr-radius)}.premium-hero-panel span{display:block;font-family:var(--pr-serif);font-size:38px;color:var(--pr-accent);line-height:1}.premium-hero-panel small{color:var(--pr-muted);font-size:11px;text-transform:uppercase;letter-spacing:.18em}.premium-strip{display:grid;grid-template-columns:repeat(6,1fr);border-top:1px solid var(--pr-border);border-bottom:1px solid var(--pr-border);background:color-mix(in oklab,var(--pr-bg) 76%,transparent);backdrop-filter:blur(16px)}.premium-strip article{padding:24px 18px;border-right:1px solid var(--pr-border);display:grid;gap:8px;transition:background .3s}.premium-strip article:hover{background:color-mix(in oklab,var(--pr-accent) 8%,transparent)}.premium-strip b{font-size:24px}.premium-strip strong{color:var(--pr-text);font-size:14px}.premium-strip span{color:var(--pr-muted);font-size:12px;line-height:1.45}.premium-section{padding:86px clamp(18px,5vw,72px);position:relative}.premium-heading{max-width:820px;margin-bottom:34px}.premium-heading p{color:var(--pr-accent);font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.34em;margin-bottom:12px}.premium-heading h2{font-family:var(--pr-serif);font-size:clamp(36px,6vw,74px);line-height:.96;margin:0;color:var(--pr-text)}.premium-heading span{display:block;color:var(--pr-muted);margin-top:14px;font-size:16px;line-height:1.65}.premium-signatures{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-bottom:34px}.premium-signature-card{position:relative;min-height:320px;overflow:hidden;border:1px solid var(--pr-border);background:var(--pr-surface);border-radius:var(--pr-radius);transition:transform .3s,box-shadow .3s,border-color .3s}.premium-signature-card:hover{transform:translateY(-4px);border-color:var(--pr-accent);box-shadow:0 16px 40px color-mix(in oklab,var(--pr-accent) 22%,transparent)}.premium-signature-card:active{transform:translateY(-1px) scale(.98)}.premium-signature-card>div{position:absolute;inset:0}.premium-signature-card img{width:100%;height:100%;object-fit:cover;transition:transform .8s}.premium-signature-card:hover img{transform:scale(1.08)}.premium-signature-card:after{content:"";position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,.86),transparent 58%)}.premium-signature-card footer{position:absolute;inset:auto 0 0;padding:18px;z-index:1}.premium-signature-card small,.premium-menu-grid small{color:var(--pr-accent);text-transform:uppercase;letter-spacing:.2em;font-size:10px;font-weight:900}.premium-signature-card strong{display:block;color:var(--pr-text);font-size:18px;margin:6px 0}.premium-signature-card span{color:var(--pr-accent);font-weight:900}.premium-tabs{display:flex;gap:9px;overflow-x:auto;margin-bottom:18px}.premium-tabs button,.premium-time-grid button{border:1px solid var(--pr-border);background:rgba(255,255,255,.04);color:var(--pr-muted);padding:10px 16px;border-radius:999px;font-weight:800;cursor:pointer;transition:transform .15s,box-shadow .2s,border-color .2s,background .2s,color .2s}.premium-tabs button.active,.premium-tabs button:hover,.premium-time-grid button.active,.premium-time-grid button:hover{background:var(--pr-accent);border-color:var(--pr-accent);color:var(--pr-ink);box-shadow:0 4px 16px color-mix(in oklab,var(--pr-accent) 40%,transparent)}.premium-tabs button:active,.premium-time-grid button:active{transform:scale(.92)}.premium-menu-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.premium-menu-grid article{display:grid;gap:18px;background:var(--pr-surface);border:1px solid var(--pr-border);padding:20px;backdrop-filter:blur(14px);border-radius:var(--pr-radius);transition:transform .25s,box-shadow .25s,border-color .25s}.premium-menu-grid article:hover{border-color:var(--pr-accent);box-shadow:0 12px 34px color-mix(in oklab,var(--pr-accent) 18%,transparent);transform:translateY(-3px)}.premium-menu-grid article:active{transform:translateY(-1px) scale(.985)}.premium-menu-grid h3{color:var(--pr-text);margin:5px 0 6px;font-size:20px}.premium-menu-grid p{color:var(--pr-muted);line-height:1.55;font-size:14px;margin:0}.premium-menu-grid footer{display:flex;align-items:center;justify-content:space-between;gap:16px;border-top:1px solid var(--pr-border);padding-top:14px}.premium-menu-grid strong{color:var(--pr-accent);font-size:18px}.premium-menu-grid a,.premium-menu-grid button{color:var(--pr-text);border:1px solid var(--pr-border);padding:8px 12px;border-radius:999px;text-decoration:none;font-size:12px;font-weight:800;background:transparent;transition:transform .15s,box-shadow .2s,border-color .2s,background .2s,color .2s}.premium-menu-grid a:hover,.premium-menu-grid button:hover{border-color:var(--pr-accent);background:var(--pr-accent);color:var(--pr-ink);box-shadow:0 4px 16px color-mix(in oklab,var(--pr-accent) 40%,transparent)}.premium-menu-grid a:active,.premium-menu-grid button:active{transform:scale(.92)}.premium-experience{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(280px,.8fr);gap:36px;align-items:start;background:linear-gradient(180deg,transparent,rgba(0,0,0,.28),transparent)}.premium-experience-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.premium-experience-list article,.premium-chef-card,.premium-qr-card,.premium-form,.premium-review-form{background:var(--pr-surface);border:1px solid var(--pr-border);backdrop-filter:blur(16px);border-radius:var(--pr-radius)}.premium-experience-list article{padding:18px}.premium-experience-list span{display:block;color:var(--pr-accent);font-size:10px;text-transform:uppercase;letter-spacing:.2em;font-weight:900;margin-bottom:8px}.premium-experience-list strong{color:var(--pr-text);font-size:14px;line-height:1.45}.premium-chef-card{padding:16px}.premium-chef-image{height:360px;overflow:hidden;border:1px solid var(--pr-border);margin-bottom:18px;border-radius:var(--pr-radius)}.premium-chef-image img{width:100%;height:100%;object-fit:cover}.premium-chef-card h3{font-family:var(--pr-serif);font-size:34px;margin:0 0 8px;color:var(--pr-text)}.premium-chef-card p{color:var(--pr-muted);line-height:1.65}.premium-gallery{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.premium-gallery figure{height:260px;margin:0;position:relative;overflow:hidden;border:1px solid var(--pr-border);background:var(--pr-surface);border-radius:var(--pr-radius)}.premium-gallery figure:nth-child(3n+1){height:340px}.premium-gallery img{width:100%;height:100%;object-fit:cover;transition:transform .8s}.premium-gallery figure:hover img{transform:scale(1.07)}.premium-gallery figcaption{position:absolute;left:12px;right:12px;bottom:12px;color:var(--pr-text);font-size:12px;background:rgba(0,0,0,.44);padding:8px}.premium-reservation{padding:90px clamp(18px,5vw,72px);background:linear-gradient(135deg,color-mix(in oklab,var(--pr-accent-2) 30%,transparent),rgba(0,0,0,.44));border-block:1px solid var(--pr-border)}.premium-reservation-inner{max-width:1320px;margin:auto}.premium-reservation-layout{display:grid;grid-template-columns:minmax(0,1fr) 330px;gap:22px}.premium-form{padding:24px;display:grid;gap:14px}.premium-form-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.premium-form label{display:grid;gap:7px;color:var(--pr-muted);font-size:11px;text-transform:uppercase;letter-spacing:.16em;font-weight:900}.premium-form input,.premium-form select,.premium-form textarea{width:100%;border:1px solid var(--pr-border);background:rgba(0,0,0,.24);color:var(--pr-text);padding:13px 14px;border-radius:calc(var(--pr-radius) * 0.65);outline:none;font:inherit;text-transform:none;letter-spacing:0}.premium-form textarea{min-height:84px;resize:vertical}.premium-time-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px}.premium-form>button{border:0;border-radius:999px;padding:16px 22px;font-weight:950;text-transform:uppercase;letter-spacing:.16em;cursor:pointer;background:var(--pr-accent);color:var(--pr-ink);transition:transform .18s,box-shadow .25s;box-shadow:0 0 0 0 color-mix(in oklab,var(--pr-accent) 60%,transparent)}.premium-form>button:hover{box-shadow:0 8px 30px color-mix(in oklab,var(--pr-accent) 50%,transparent);transform:translateY(-2px)}.premium-form>button:active{transform:scale(.96) translateY(0)}.premium-form>button:disabled{opacity:.62}.premium-qr-card{padding:22px;text-align:center}.premium-qr-card h3{font-family:var(--pr-serif);font-size:30px;margin:0 0 10px;color:var(--pr-text)}.premium-qr-card p{color:var(--pr-muted);line-height:1.55;font-size:14px}.premium-qr-card img,.premium-qr-placeholder{width:210px;height:210px;margin:18px auto;background:var(--pr-accent);padding:12px;border-radius:calc(var(--pr-radius) * 1.4)}.premium-qr-placeholder{display:grid;place-items:center;color:var(--pr-ink);font-weight:900;font-size:40px}.premium-contact-mini{display:grid;gap:8px;text-align:left;color:var(--pr-muted);font-size:12px}.premium-review-form{padding:22px;margin-top:26px;max-width:720px}.premium-footer{display:flex;justify-content:space-between;gap:20px;flex-wrap:wrap;padding:34px clamp(18px,5vw,72px);border-top:1px solid var(--pr-border);background:var(--pr-bg)}.premium-footer strong{display:block;font-family:var(--pr-serif);font-size:30px;color:var(--pr-accent)}.premium-footer span,.premium-footer a{display:block;color:var(--pr-muted);text-decoration:none;margin-top:6px}.premium-feu .premium-bg img{animation-duration:12s}.premium-royal .premium-signature-card,.premium-royal .premium-menu-grid article,.premium-royal .premium-form,.premium-royal .premium-qr-card{box-shadow:inset 0 0 0 1px color-mix(in oklab,var(--pr-accent) 18%,transparent),0 24px 80px rgba(0,0,0,.34)}
.premium-feu .premium-signature-card,.premium-feu .premium-menu-grid article{transition:box-shadow .4s,transform .4s}.premium-feu .premium-signature-card:hover,.premium-feu .premium-menu-grid article:hover{box-shadow:0 0 0 1px color-mix(in oklab,var(--pr-accent) 45%,transparent),0 0 46px color-mix(in oklab,var(--pr-accent) 35%,transparent),0 20px 60px rgba(0,0,0,.5);transform:translateY(-3px)}
.premium-nuit .premium-bg span{background:linear-gradient(90deg,rgba(0,0,0,.9),rgba(0,0,0,.55),rgba(0,0,0,.92)),radial-gradient(circle at 50% 10%,color-mix(in oklab,var(--pr-accent) 16%,transparent),transparent 40%)}.premium-nuit .premium-hero h1{text-shadow:0 22px 70px rgba(0,0,0,.8),0 0 46px color-mix(in oklab,var(--pr-accent) 22%,transparent)}
